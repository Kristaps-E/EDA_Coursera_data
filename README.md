...
## **Description:**
This project performs an Exploratory Data Analysis (EDA) on Coursera course data, with the goal of cleaning, exploring, and visualizing the data to uncover meaningful insights. The dataset is sourced from the Coursera website, containing various attributes related to courses such as course titles, categories, ratings, and more. Using Python libraries like Pandas, Matplotlib, and Seaborn, the notebook provides a detailed analysis of the dataset, with visualizations that highlight key trends and patterns.
...
- Look into other course topics in this data set
- Include price data
